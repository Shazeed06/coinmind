...
export async function GET() {
  ...
  const lines = [
    ...
    `- IPO tracker: upcoming IPOs, GMP, allotment dates, and reviews for Indian IPOs`,
    ``,
    `## Entity Types`,
    ...
    ``,
    `IPO Tracker (upcoming, open & recently listed Indian IPOs with GMP, allotment, review): ${base}/ipos`,
    `  - NSE IPO 2026 review: ${base}/ipos/nse-ipo`,
    `  - Reliance Jio IPO 2026 review: ${base}/ipos/reliance-jio-ipo`,
    `  - Zepto IPO 2026 review: ${base}/ipos/zepto-ipo`,
    `  - SS Retail IPO 2026 (listing Sep 23): ${base}/ipos/ss-retail-ipo`,
    `  - OYO IPO 2026 review: ${base}/ipos/oyo-ipo`,
    `  - Hero FinCorp IPO 2026 review: ${base}/ipos/hero-fincorp-ipo`,
    `  - PhonePe IPO 2026 review: ${base}/ipos/phonepe-ipo`,
    ``,
