...
const faqs = [
  ...
  {
    q: "How strong is a 16 character password?",
    a: "With all four character types enabled the pool is roughly 90 characters, which gives about 6.5 bits of entropy per character and roughly 104 bits for a 16 character password. That is far beyond what offline brute-force cracking can reach, and it is the level most security guidance treats as future-proof. The practical risk shifts entirely to phishing, malware and reuse rather than guessing.",
  },
  {
    q: "Does the generator work on a phone and offline?",
    a: "Yes to both. The Web Crypto API is built into every current mobile and desktop browser, so crypto.getRandomValues works identically on a phone. Because no network request is involved at any stage, the page keeps generating passwords with no connection once it has loaded. Turning on the exclude ambiguous characters option is worth it when you will be typing on a small keyboard.",
  },
];
