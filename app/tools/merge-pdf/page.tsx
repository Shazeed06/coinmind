...
const faqs = [
  ...
  {
    q: "Can I merge PDFs on a phone or tablet?",
    a: "Yes. The drop zone and the file list are responsive, so the tool works in mobile Chrome, Safari and Firefox. Tap the drop zone to pick PDFs from your files app or cloud storage, reorder them with the arrow buttons, and the merged file saves to your downloads. Very large image-heavy PDFs may be slower on a phone than on a laptop.",
  },
  {
    q: "Can I add images or Word documents to the merge?",
    a: "Not directly. This tool reads PDF files only. To include a JPG or PNG, turn it into a PDF first with the Image to PDF tool on this site, then add the result here. For a Word or Excel file, export or print it to PDF from the application that created it, then merge that copy.",
  },
];
