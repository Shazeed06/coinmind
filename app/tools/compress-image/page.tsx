...
const faqs = [
  ...
  {
    q: "Does compressing an image remove EXIF data such as GPS location?",
    a: "Yes, as a side effect of how it works. The photo is decoded to raw pixels and re-encoded by the canvas, so metadata like the camera model, capture date and GPS coordinates is not carried into the new file. That is handy when you want to strip location data before sharing, but keep the original if you need those details later.",
  },
];
