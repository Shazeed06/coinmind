...
const faqData = [
  ...
  {
    q: "Should I enter my monthly or my annual income?",
    a: "Enter your annual, pre-tax personal income. If you are paid monthly, multiply your salary by 12 first; if you are paid weekly, multiply by 52. The reference points behind the tool are all yearly figures, so typing a monthly amount will place you far lower in the ranking than you actually sit.",
  },
];
