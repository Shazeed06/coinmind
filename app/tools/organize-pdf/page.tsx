...
const faqData = [
  ...
  },
  {
    ...
    a: "There is no fixed limit built into the tool. Because the whole document is held in browser memory while you work, the practical ceiling is your device's available RAM. Documents of a few hundred pages are comfortable. Very large scanned files with thousands of high-resolution pages may feel sluggish, especially on a phone, so close other tabs if things slow down.",
  },
  {
    q: "Do bookmarks, links and form fields survive the rebuild?",
    a: "Page content, hyperlinks and page-level annotations generally carry across because each kept page is copied whole. Document-level features are less reliable: the bookmark outline, interactive form fields and embedded scripts depend on structures that point at the old page order, so they may not survive. If your file relies on a fillable form, test the output before sending it.",
  },
];
