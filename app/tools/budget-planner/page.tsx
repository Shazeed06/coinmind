...
const faqs = [
  ...
  {
    q: "Will my budget still be there when I come back later?",
    a: "Yes, on the same browser and the same device. Your income figure, currency choice and every expense line are saved to that browser's local storage, so closing the tab or shutting the laptop does not lose them. They will not follow you to another device, and clearing your browsing data or using a private window will wipe the saved budget.",
  },
  {
    q: "Which currencies does the budget planner support?",
    a: "You can switch between the Indian rupee, the US dollar and the pound sterling using the currency toggle above the income field, and your choice is remembered along with the rest of your budget. The setting only changes the symbol and number formatting. There is no exchange rate conversion, so enter every figure in the one currency you picked.",
  },
];
