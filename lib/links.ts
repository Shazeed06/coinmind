...
export const CLUSTER_SIP = {
  ...
  links: [
    ...
    // Slug shapes come from lib/pseo-sip.ts and lib/pseo-sip-years.ts: both
    // now served by app/sip/[slug]. Only amounts in SIP_AMOUNTS resolve.
    mk("₹5,000 SIP for 10 Years", "/sip/5000-per-month-for-10-years", "Year-by-year SIP return scenarios"),
    mk("₹5,000 Monthly SIP", "/sip/5000-per-month", "Projected corpus for a ₹5,000 monthly SIP over 5-30 years"),
...
export const CLUSTER_TAX = {
  ...
  links: [
    ...
    // Slugs generated by lib/pseo-tax.ts (TAX_SLUGS) and lib/pseo-inhand.ts
    // (INHAND_SLUGS): "<n>-lakh"/"<n>-crore" and "<n>-lpa" respectively.
    mk("Income Tax on ₹12 Lakh Salary", "/income-tax/12-lakh", "Salary-specific tax regime comparisons"),
    mk("₹12 LPA In-Hand Salary", "/in-hand-salary/12-lpa", "Salary-specific take-home calculations"),
  ],
};
